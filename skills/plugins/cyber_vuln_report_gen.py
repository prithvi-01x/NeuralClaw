"""
skills/plugins/cyber_vuln_report_gen.py — Cyber: Vulnerability Report Generator

Generates a structured vulnerability assessment report in Markdown from
provided findings data. Pure document generation — no scanning performed here.
