...
Usage:
    from neuralclaw.brain.capabilities import get_capabilities, ModelCapabilities

    caps = get_capabilities("ollama", "codellama:latest")
    if not caps.supports_tools:
        from neuralclaw.observability.logger import get_logger as _caps_log; _caps_log("brain.capabilities").info("model.chat_only_mode", provider=provider, model=model_id)
