...
from neuralclaw.interfaces.model_selector import (
    run_model_selector,
...
from neuralclaw.skills.discovery import (
    fuzzy_search_skills, skill_detail, group_by_category,
    skill_type_icon, missing_grant_hints,
)
from neuralclaw.exceptions import NeuralClawError, MemoryError as NeuralClawMemoryError, LLMError

log = get_logger(__name__)

# ── Constants ─────────────────────────────────────────────────────────────────

from neuralclaw.interfaces.branding import NEURALCLAW_BANNER as _BANNER
...
def _make_adhoc_option(provider: str, model_id: str):
    ...
    from neuralclaw.interfaces.model_selector import ModelOption
    return ModelOption(
...
class CLIInterface:
    ...
    def _cmd_resetcaps(self) -> None:
        ...
        """
        from neuralclaw.agent.orchestrator import _provider_name_from_client
