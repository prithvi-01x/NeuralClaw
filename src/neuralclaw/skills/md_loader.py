...
from neuralclaw.skills.md_skill import MarkdownSkill
from neuralclaw.skills.registry import SkillRegistry
from neuralclaw.skills.types import RiskLevel, SkillManifest, SkillValidationError
...
class MarkdownSkillLoader:
    ...
    def get_instructions_block(self, registry: SkillRegistry) -> str:
        ...
        """
        from neuralclaw.skills.md_skill import MarkdownSkill as _MdSkill
